        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl shadow-xl p-8 mb-8 text-white">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-green-100">Manage your farm products and customer orders</p>
                  </div>
                </div>
              ...
              <div className="text-right">
                <div className="text-sm text-green-200 mb-1">Total Earnings</div>
                <div className="text-5xl font-bold">${totalEarnings.toFixed(2)}</div>
                <div className="text-sm text-green-200 mt-2">{completedOrders.length} completed orders</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 rounded-xl p-6 border-2 border-yellow-200 dark:border-yellow-800">
              ...
              <div className="text-3xl font-bold text-yellow-600 dark:text-yellow-400">{pendingOrders.length}</div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Awaiting processing</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6 border-2 border-green-200 dark:border-green-800">
              ...
              <div className="text-3xl font-bold text-green-600 dark:text-green-400">${totalEarnings.toFixed(2)}</div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">All-time revenue</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl p-6 border-2 border-blue-200 dark:border-blue-800">
              ...
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400">${inEscrow.toFixed(2)}</div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Secured funds</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border-2 border-purple-200 dark:border-purple-800">
              ...
              <div className="text-3xl font-bold text-purple-600 dark:text-purple-400">{topProducts.length}</div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Listed for sale</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-8">
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Manage Orders</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Process customer orders</p>
            </button>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">My Products</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Manage farm inventory</p>
            </button>
            ...
            >
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Sales insights</p>
            </button>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg mb-8">
            ...
            <div className="p-6">
                  ...
                  {myEscrows.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {myEscrows.slice(0, 5).map(order => (
                        <div key={order.id} className="bg-gray-50 dark:bg-slate-700/50 rounded-xl p-6 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors">
                          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <h4 className="font-semibold text-gray-900 dark:text-white">{order.productName}</h4>
                                <div className="flex items-center gap-3 mt-1">
                                  <span className="text-sm text-gray-600 dark:text-gray-400">ID: {order.id.slice(0, 8)}...</span>
              ...
              {activeTab === 'products' && (
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Top Selling Products</h3>
                    <button 
                      onClick={() => navigate('/products')}
                  ...
                  <div className="space-y-4">
                    {topProducts.map(product => (
                      <div key={product.id} className="bg-gray-50 dark:bg-slate-700/50 rounded-xl p-6 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <div className="text-2xl font-bold text-gray-900 dark:text-white">₦{product.price.toLocaleString()}</div>
                            <div className="text-sm text-green-600 dark:text-green-400">₦{(product.price * product.sales).toLocaleString()} revenue</div>
                          </div>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-8">
                    <div className="grid grid-cols-2 gap-6 max-w-md mx-auto">
                      <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl p-4 text-center">
                        <div className="text-3xl font-bold text-green-600 dark:text-green-400">{pendingOrders.length}</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">Pending Orders</div>
                      </div>
                      <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl p-4 text-center">
                        <div className="text-3xl font-bold text-blue-600 dark:text-blue-400">{verifiedOrders.length}</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">In Transit</div>
                      </div>
                      <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl p-4 text-center">
                        <div className="text-3xl font-bold text-purple-600 dark:text-purple-400">{completedOrders.length}</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">Delivered</div>
                      </div>
                      <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl p-4 text-center">
                        <div className="text-3xl font-bold text-yellow-600 dark:text-yellow-400">{topProducts.length}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                All transactions protected by blockchain escrow. Funds released only after delivery confirmation.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Your sales are growing steadily. Consider adding more variety to your product lineup.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Maintain high ratings by ensuring prompt delivery and quality produce.
              </p>
            </div>
          </div>
        </div>
