  ...
  return (
    ...
    <div className="min-h-screen mt-14 bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Blockchain Transactions</h1>
          <p className="text-gray-600">View all your transactions on the blockchain</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="divide-y divide-gray-200">
            {filteredTxs.map(tx => (
              <div
                key={tx.hash}
                onClick={() => navigate('/transaction', { hash: tx.hash })}
