...
const ProductDetails = () => {
      ...
      try {
        ...
        if (foundProduct) {
          ...
          const transformedProduct = {
            ...
            quantityAvailable:
              foundProduct.quantity || foundProduct.quantityAvailable || 0,
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-b from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-950 flex items-center justify-center p-6">
      ...
      <div className="min-h-screen bg-linear-to-b from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-950 flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-linear-to-r from-green-600 to-emerald-600 text-white rounded-xl font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-200"
          >
            Back to Shop
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-950 py-8 px-4 sm:px-6 lg:px-8">
      {/* Back Button */}
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white dark:bg-slate-800 shadow-2xl rounded-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            {/* Left Image Section */}
            <div className="relative bg-linear-to-br from-gray-100 to-gray-200 dark:from-slate-700 dark:to-slate-800 p-8 flex items-center justify-center">
              <div className="relative">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = `https://placehold.co/600x400/10b981/white?text=${encodeURIComponent(
                      name
                    )}`;
                  }}
                />
            ...
            <div className="p-8 lg:p-10 flex flex-col justify-between">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="h-1 w-20 bg-linear-to-r from-green-600 to-emerald-600 rounded-full"></div>
                </div>
                ...
                <div className="bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-6 border-2 border-green-200 dark:border-green-800">
